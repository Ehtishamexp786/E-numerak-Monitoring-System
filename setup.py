...
==============================================
Yeh script poora empty folder/file structure bana deta hai.

Run karne ka tareeqa (kisi bhi terminal mein - PowerShell, CMD, Git Bash):
    python setup.py

Bas itna hi. Koi extra package install karne ki zaroorat nahi,
sirf Python installed hona chahiye (3.x).
==============================================
"""
